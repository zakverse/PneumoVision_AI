    ...
    <header className="sticky top-2 sm:top-4 z-50 w-full max-w-7xl mx-auto px-3 sm:px-6 mb-6 sm:mb-8">
      <nav className="clay-card py-2.5 sm:py-3.5 px-3.5 sm:px-6 flex items-center justify-between backdrop-blur-md bg-white/95 relative">
        ...
        <a href="#" className="flex items-center gap-2.5 sm:gap-3 group shrink-0">
          <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-white flex items-center justify-center p-1 shadow-clay-sm border-2 border-mint-border group-hover:rotate-6 transition-transform overflow-hidden shrink-0">
            <img
          ...
          <div>
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="hidden sm:inline-block px-2 py-0.5 rounded-full text-[11px] font-bold bg-teal-soft text-teal-dark border border-teal/30">
                v1.0 • ResNet18
              </span>
            </div>
        ...
        <div className="hidden lg:flex items-center gap-1 bg-mint-light p-1.5 rounded-2xl border-2 border-mint-border">
          {navLinks.map((link) => (
            <a
              key={link.href}
              href={link.href}
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-2xl bg-mint-light border-2 border-mint-border text-navy hover:text-teal hover:bg-white transition-all shadow-sm focus:outline-none"
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden mt-2 clay-card p-4 bg-white/98 backdrop-blur-lg border-2 border-mint-border shadow-clay-card animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="flex flex-col gap-2">
            {navLinks.map((link) => (
              <a
                ...
                className="px-4 py-2.5 rounded-xl font-heading font-semibold text-navy hover:text-teal hover:bg-mint-light active:bg-teal-soft transition-all flex items-center justify-between"
              >
            ...
            <div className="pt-2 mt-1 border-t border-mint-border">
              <a
                href="#detect"
                onClick={handleNavClick}
