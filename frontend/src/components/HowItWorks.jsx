  ...
  const steps = [
    {
      ...
      icon: Upload,
      badgeClass: "bg-[#1677D2] text-white border-[#1162B0]"
    },
    {
      step: "02",
      ...
      icon: ScanEye,
      badgeClass: "bg-slate-100 text-[#123B78] border-slate-200"
    },
    {
      step: "03",
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
        {steps.map((item, idx) => {
          ...
          return (
            <div
              key={idx}
              className="clay-card p-5 sm:p-7 bg-white border-2 border-slate-200 text-[#123B78] flex flex-col justify-between relative transition-all duration-200 hover:-translate-y-1"
            >
              <div>
                <div className="flex items-center justify-between mb-4 sm:mb-5">
                  ...
                  <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-slate-100 border border-slate-200 flex items-center justify-center text-[#1677D2] shadow-sm">
                    <Icon size={19} className="stroke-[2.5]" />
                  </div>
                </div>

                <h3 className="font-heading text-xl font-bold mb-1.5 text-[#123B78]">
                  {item.title}
                </h3>
              ...
              <div className="mt-5 sm:mt-6 pt-3 border-t border-slate-100 flex items-center gap-2 text-[11px] sm:text-xs font-heading font-bold text-[#1677D2]">
