...
export default function FinalCTA() {
  return (
    <section className="w-full max-w-7xl mx-auto px-3 sm:px-6 py-8 sm:py-12">
      <div className="relative overflow-hidden rounded-2xl sm:rounded-[28px] bg-navy p-6 sm:p-12 text-center text-white border-2 border-navy-surface shadow-clay-card">
        <div className="relative z-10 max-w-2xl mx-auto space-y-3 sm:space-y-4">
          <div className="inline-flex items-center gap-2 px-3 sm:px-3.5 py-1 rounded-full bg-white/10 border border-white/15 text-[11px] sm:text-xs font-heading font-bold uppercase tracking-wider text-teal-light">
          ...
          <div className="pt-2 sm:pt-3">
            <a
              href="#detect"
              className="clay-btn clay-btn-teal text-white text-xs sm:text-sm px-6 sm:px-8 py-3.5 shadow-clay-btn-teal hover:scale-105 transition-transform w-full sm:w-auto justify-center"
            >
