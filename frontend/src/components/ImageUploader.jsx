    ...
    <div className="clay-card p-4 sm:p-7 bg-white flex flex-col justify-between h-full">
      <div>
        ...
        <div className="flex items-center justify-between mb-4 sm:mb-5">
          ...
          {hasImage && (
            <button
              type="button"
              onClick={onReset}
              className="clay-btn clay-btn-white text-[11px] sm:text-xs px-2.5 sm:px-3 py-1 text-[#123B78]/70 hover:text-[#1677D2] shadow-clay-sm"
        ...
        <div
          ...
          className={`relative rounded-2xl sm:rounded-3xl border-2 border-dashed p-5 sm:p-8 text-center cursor-pointer transition-all duration-200 group ${
            isDragOver
              ? 'border-[#1677D2] bg-[#EAF4FF]/40 scale-[1.01]'
              : hasImage
              ? 'border-slate-300 bg-slate-50 hover:bg-white'
              : 'border-slate-300 bg-slate-50/70 hover:bg-white hover:border-[#1677D2]/60 shadow-inner'
          }`}
        >
          <div className="py-2 sm:py-4 flex flex-col items-center">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl sm:rounded-3xl bg-white border-2 border-slate-200 shadow-clay-sm flex items-center justify-center text-[#1677D2] mb-3 group-hover:scale-110 group-hover:rotate-6 transition-transform">
              <UploadCloud size={30} className="stroke-[2.5]" />
            </div>

            <h4 className="font-heading font-bold text-sm sm:text-base text-[#123B78] mb-1">
              Seret dan lepas gambar di sini
            </h4>
            <p className="text-[11px] sm:text-xs text-[#123B78]/60 font-medium mb-1">
              atau klik untuk memilih gambar dari perangkat Anda
            </p>
            <p className="text-[10px] sm:text-[11px] font-semibold text-[#123B78]/70 bg-slate-100 px-2.5 py-0.5 rounded-full border border-slate-200 mb-3.5">
              JPG, JPEG, atau PNG
            </p>
            ...
            <button
              ...
              className="clay-btn clay-btn-white text-xs sm:text-sm px-4 py-2 text-[#123B78] shadow-clay-sm"
            >
              <ImageIcon size={15} className="text-[#1677D2]" />
        ...
        <div className="mt-4 sm:mt-5 pt-3 sm:pt-4 border-t border-slate-200">
          <div className="flex items-center gap-1.5 text-[11px] sm:text-xs font-heading font-bold text-[#123B78]/70 mb-2.5">
            <Wand2 size={13} className="text-[#1677D2]" />
              ...
              return (
                <button
                  ...
                  className={`clay-btn text-xs py-2 px-3 justify-center transition-all ${
                    isSelected
                      ? 'clay-btn-blue text-white shadow-clay-btn-blue'
                      : 'clay-btn-white text-[#123B78] hover:text-[#1677D2] shadow-clay-sm'
                  }`}
                >
                  <FileText size={13} className={isSelected ? 'text-white' : 'text-[#1677D2]'} />
                  <span className="font-heading font-bold">{sample.label}</span>
                </button>
              );
            })}
          </div>
          <p className="text-[10px] text-[#123B78]/50 font-medium mt-1.5 text-center">
      ...
      <div className="mt-5 sm:mt-6">
        <button
          ...
          className="clay-btn clay-btn-blue w-full py-3.5 sm:py-4 text-sm sm:text-base shadow-clay-btn-blue flex items-center justify-center gap-2 sm:gap-3"
        >
          {isLoading ? (
            <>
